    ...
    Value makeRsubMethod(const Value& obj) {
        ...
        return makeBuiltin(
            ...
            [set](const std::vector<Value> &args,
                ...
                return set->rsub(args[0]);
            }
        );
    }

    Value makeIsubMethod(const Value& obj) {
        ...
        return makeBuiltin(
            ...
            [set](const std::vector<Value> &args,
                ...
                expectArgs(args, 1, "__isub__");

                return set->isub(args[0]);
            }
        );
    }
    ...
    Value makeIxorMethod(const Value& obj) {
        ...
        return makeBuiltin(
            ...
            [set](const std::vector<Value> &args,
                ...
                expectArgs(args, 1, "__ixor__");

                return set->ixor(args[0]);
            }
        );
    }
    ...
    Value makeGeMethod(const Value& obj) {
        ...
        return makeBuiltin(
            ...
            [set](const std::vector<Value> &args,
                ...
                return Value(set->greaterOrEqual(args[0]));
            }
        );
    }
